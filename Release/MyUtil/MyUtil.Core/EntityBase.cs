    ...
    public abstract class EntityBase
    {
        ...
        protected void LogInOut()
        {
            try
            {
                ...
                Logging("InputData:" + Input + "_______" + "OutputData:" + Output, LogType.Info);
            }
            catch (Exception ex)
            {
                try
        ...
        protected void Logging(string message, LogType en)
        {
            try
            {
                ...
                message = new StringBuilder().Append(ClassName).Append(".").Append(MethodName).Append(".UserName=").Append(UserName).Append(".").Append(threadInfo).Append(message).ToString();
                switch (en)
                {
                    case LogType.Debug:

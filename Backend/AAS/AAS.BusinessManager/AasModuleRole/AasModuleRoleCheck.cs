...
{
    partial class AasModuleRoleCheck : BusinessBase
    {
        internal AasModuleRoleCheck()
            : base()
        {

        }

        internal AasModuleRoleCheck(CommonParam paramCheck)
            : base(paramCheck)
        {
        ...
        internal bool VerifyId(long id)
        {
            ...
            try
            {
                if (new ModuleRoleManagerGet().GetById(id) == null)
                {
        ...
        internal bool VerifyIds(List<long> listId)
        {
            ...
            try
            {
                ...
                {
                    ModuleRoleFilterQuery filter = new ModuleRoleFilterQuery();
                    filter.Ids = listId;
                    List<ModuleRole> listData = new ModuleRoleManagerGet().Get(filter);
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        internal bool VerifyIds(List<long> listId, List<ModuleRole> listObject)
        {
            bool valid = true;
            try
            {
        ...
        internal bool IsUnLock(long id)
        {
            ...
            try
            {
                if (!DAOWorker.AasModuleRoleDAO.IsUnLock(id))
                {
                    valid = false;
                    MessageUtil.SetMessage(param, LibraryMessage.Message.Enum.Common__DuLieuDangBiKhoa);
                }
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        internal bool IsUnLock(List<ModuleRole> listData)
        {
            bool valid = true;
            try
            {

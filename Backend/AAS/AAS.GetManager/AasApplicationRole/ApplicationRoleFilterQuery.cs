...
{
    public class ApplicationRoleFilterQuery : AasApplicationRoleFilter
    {
        public ApplicationRoleFilterQuery()
            : base()
        {

        }

        internal List<System.Linq.Expressions.Expression<Func<ApplicationRole, bool>>> listExpression = new List<System.Linq.Expressions.Expression<Func<ApplicationRole, bool>>>();

        internal AasApplicationRoleSO Query()
        {
            AasApplicationRoleSO search = new AasApplicationRoleSO();
            try
            {
                ...
                {
                    listExpression.Add(o => o.ApplicationId == this.ApplicationId.Value);
                }
                ...
                search.listApplicationRoleExpression.AddRange(listExpression);
            ...
            {
                LogSystem.Error(ex);
                search.listApplicationRoleExpression.Clear();
                search.listApplicationRoleExpression.Add(o => o.Id == NegativeId);
            }
            return search;
        }
    }

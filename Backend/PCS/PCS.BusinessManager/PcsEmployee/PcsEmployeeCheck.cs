...
{
    partial class PcsEmployeeCheck : BusinessBase
    {
        internal PcsEmployeeCheck()
            : base()
        {
        ...
        internal bool VerifyId(long id)
        {
            ...
            try
            {
                if (new PcsEmployeeManagerGet().GetById(id) == null)
                {
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        internal bool VerifyId(long id, ref Employee data)
        {
            bool valid = true;
            try
            {
                data = new PcsEmployeeManagerGet().GetById(id);
                if (data == null)
                {
                    BugUtil.SetBugCode(param, LibraryBug.Bug.Enum.Common__KXDDDuLieuCanXuLy);
                    Logging("Id invalid." + LogUtil.TraceData("id", id), LogType.Error);
        ...
        internal bool VerifyIds(List<long> listId)
        {
            ...
            try
            {
                ...
                {
                    PcsEmployeeFilterQuery filter = new PcsEmployeeFilterQuery();
                    filter.Ids = listId;
                    List<Employee> listData = new PcsEmployeeManagerGet().Get(filter);
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        internal bool VerifyIds(List<long> listId, List<Employee> listObject)
        {
            bool valid = true;
            try
            {
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        internal bool IsUnLock(Employee data)
        {
            bool valid = true;
            try
            {
        ...
        internal bool IsUnLock(long id)
        {
            ...
            try
            {
                if (!DAOWorker.PcsEmployeeDAO.IsUnLock(id))
                {
                    valid = false;
                    MessageUtil.SetMessage(param, LibraryMessage.Message.Enum.Common__DuLieuDangBiKhoa);
                }
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        internal bool IsUnLock(List<Employee> listData)
        {
            bool valid = true;
            try
            {
